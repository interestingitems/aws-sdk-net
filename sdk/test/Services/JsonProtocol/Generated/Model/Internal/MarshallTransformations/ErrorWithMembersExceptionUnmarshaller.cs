...
namespace Amazon.JsonProtocol.Model.Internal.MarshallTransformations
{
    ...
    public class ErrorWithMembersExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<ErrorWithMembersException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public ErrorWithMembersException Unmarshall(JsonUnmarshallerContext context, ref Utf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public ErrorWithMembersException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref Utf8JsonReader reader)
        {
