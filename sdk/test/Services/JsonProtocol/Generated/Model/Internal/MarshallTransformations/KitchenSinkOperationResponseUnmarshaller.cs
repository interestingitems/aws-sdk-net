    ...
    public class KitchenSinkOperationResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, false, null))
            {
                ...
                {
                    return ErrorWithMembersExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("ErrorWithoutMembers"))
                {
                    return ErrorWithoutMembersExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
            }
