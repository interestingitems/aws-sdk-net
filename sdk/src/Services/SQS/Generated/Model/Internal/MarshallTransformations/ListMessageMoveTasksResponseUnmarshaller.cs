    ...
    public class ListMessageMoveTasksResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public AmazonWebServiceResponse Unmarshall(JsonUnmarshallerContext context)
        {
            ...
            while (context.ReadAtDepth(targetDepth, ref reader))
            {
                ...
                {
                    var unmarshaller = new ListUnmarshaller<ListMessageMoveTasksResultEntry, ListMessageMoveTasksResultEntryUnmarshaller>(ListMessageMoveTasksResultEntryUnmarshaller.Instance);
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, true, context.ResponseData))
            {
                ...
                {
                    return ResourceNotFoundExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
