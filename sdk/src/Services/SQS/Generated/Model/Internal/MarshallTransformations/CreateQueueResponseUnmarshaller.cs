    ...
    public class CreateQueueResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, true, context.ResponseData))
            {
                ...
                {
                    return InvalidAttributeNameExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("InvalidAttributeValue"))
                {
                    return InvalidAttributeValueExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
                ...
                {
                    return QueueDeletedRecentlyExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
                if (errorResponse.Code != null && errorResponse.Code.Equals("QueueNameExists"))
                {
                    return QueueNameExistsExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
