...
namespace Amazon.SQS.Model.Internal.MarshallTransformations
{
    ...
    public class KmsInvalidStateExceptionUnmarshaller : IJsonErrorResponseUnmarshaller<KmsInvalidStateException, JsonUnmarshallerContext>
    {
        ...
        /// <returns></returns>
        public KmsInvalidStateException Unmarshall(JsonUnmarshallerContext context, ref Utf8JsonReader reader)
        {
        ...
        /// <param name="reader"></param>
        /// <returns></returns>
        public KmsInvalidStateException Unmarshall(JsonUnmarshallerContext context, Amazon.Runtime.Internal.ErrorResponse errorResponse, ref Utf8JsonReader reader)
        {
