    ...
    public class ChangeMessageVisibilityResponseUnmarshaller : JsonResponseUnmarshaller
    {
        ...
        public override AmazonServiceException UnmarshallException(JsonUnmarshallerContext context, Exception innerException, HttpStatusCode statusCode)
        {
            ...
            using (var contextCopy = new JsonUnmarshallerContext(streamCopy, true, context.ResponseData))
            {
                ...
                {
                    return MessageNotInflightExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
                ...
                {
                    return ReceiptHandleIsInvalidExceptionUnmarshaller.Instance.Unmarshall(contextCopy, errorResponse, ref reader);
                }
