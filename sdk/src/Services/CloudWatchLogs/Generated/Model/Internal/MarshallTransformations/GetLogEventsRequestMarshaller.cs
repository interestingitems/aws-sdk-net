    ...
    public class GetLogEventsRequestMarshaller : IMarshaller<IRequest, GetLogEventsRequest> , IMarshaller<IRequest,AmazonWebServiceRequest>
    {
        ...
        public IRequest Marshall(GetLogEventsRequest publicRequest)
        {
            ...
            if(publicRequest.IsSetEndTime())
            {
                ...
                context.Writer.WriteNumberValue(Amazon.Runtime.Internal.Transform.CustomMarshallTransformations.ConvertDateTimeToEpochMilliseconds(publicRequest.EndTime.Value));
            }
            ...
            if(publicRequest.IsSetStartTime())
            {
                ...
                context.Writer.WriteNumberValue(Amazon.Runtime.Internal.Transform.CustomMarshallTransformations.ConvertDateTimeToEpochMilliseconds(publicRequest.StartTime.Value));
            }
