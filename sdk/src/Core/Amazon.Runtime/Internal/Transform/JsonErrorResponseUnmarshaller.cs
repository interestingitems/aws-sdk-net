...
namespace Amazon.Runtime.Internal.Transform
{
    ...
    public class JsonErrorResponseUnmarshaller : IJsonUnmarshaller<ErrorResponse, JsonUnmarshallerContext>
    {
        ...
        public ErrorResponse Unmarshall(JsonUnmarshallerContext context, ref Utf8JsonReader reader)
        {
        ...
        private static void GetValuesFromJsonIfPossible(JsonUnmarshallerContext context, ref Utf8JsonReader reader,  out string type, out string message, out string code)
        {
            code = null;
            type = null;
            message = null;
        ...
        private static bool TryReadContext(JsonUnmarshallerContext context, ref Utf8JsonReader reader)
        {
            try
            {
