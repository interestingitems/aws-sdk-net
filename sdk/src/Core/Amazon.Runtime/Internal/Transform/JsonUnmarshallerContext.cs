...
namespace Amazon.Runtime.Internal.Transform
{
    ...
    public class JsonUnmarshallerContext : UnmarshallerContext
    {
        ...
        public bool Peek(JsonTokenType token, ref Utf8JsonReader reader)
        {
            if (wasPeeked)
        ...
        public string ReadText(ref Utf8JsonReader reader)
        {
            ...
            switch (currentToken)
            {
                ...
                case JsonTokenType.False:
                    text = reader.GetBoolean().ToString();
                    break;
                default:
        ...
        private void UpdateContext(ref Utf8JsonReader reader)
        {
